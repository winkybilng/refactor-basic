...
public class Receipt {
    ...
    public double CalculateGrandTotal(List<Product> products, List<OrderItem> items) {
        ...
        BigDecimal subReducedPrice = calculateReducedPrice(subTotal, products, items);

        BigDecimal taxTotal = subReducedPrice.multiply(tax);
        BigDecimal grandTotal = subReducedPrice.add(taxTotal);
    ...
    private BigDecimal calculateReducedPrice(BigDecimal subTotal,List<Product> products, List<OrderItem> items) {
        for (Product product : products )  {
